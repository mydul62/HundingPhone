...
const showAll = () => {
  ...
  loadPhoneDetails(null , isShowAll);
};
...
const showDetails = async (id) => {
  ...
  <h3 class=" text-2xl text-[#403F3F]">Display Size : <span class=" text-xl text-[#706F6F]">${
    phones.mainFeatures.displaySize
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Chipset : <span class=" text-xl text-[#706F6F]">${
    phones.mainFeatures.chipSet
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Memory : <span class=" text-xl text-[#706F6F]">${
    phones.mainFeatures.memory
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Storage : <span class=" text-xl text-[#706F6F]">${
    phones.mainFeatures.storage
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Slug : <span class=" text-xl text-[#706F6F]">${
    phones.slug
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Release data : <span class=" text-xl text-[#706F6F]">${
    phones.releaseDate ? phones.releaseDate : "Not available"
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">Brand : <span class=" text-xl text-[#706F6F]">${
    phones.brand
  }</span></h3>
  <h3 class=" text-2xl text-[#403F3F]">GPS :<span class=" text-xl text-[#706F6F]"> ${
    phones.others.GPS ? phones.others.GPS : "Not available"
  }</span></h3>
  </div>
